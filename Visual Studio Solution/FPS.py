...
class FPS(object):
	...
	def Init():
		...
		FPS.s_Self.m_Font = pygame.font.SysFont("Pokemon_FireRed.ttf", 18)
	...
	def Update():
		...
		FPS.s_Self.m_FpsText = FPS.s_Self.m_Font.render("FPS: " + str(FPS.s_Self.m_CurrentFPS), 1, System.Color.RED)
		
		FPS.s_Self.m_FpsTextRect = FPS.s_Self.m_FpsText.get_rect()
		
		FPS.s_Self.m_FpsTextRect.move_ip(Graphics.GetDimensions()[0] / 2, 10)
